...
book_img = pygame.image.load('img/book.png').convert_alpha()

shopkeeper_images = []
for i in range(5):  
    img_path = os.path.join(os.path.dirname(__file__), f'Shopkeeper/{i}.png')
...
def load_question_bank(selected_level):
    ...
    level_to_filename = {
        "Cardiovascular": "cardiovascular_questions.json",
        "EKG": "ekg_questions.json",
        "Gastrointestinal": "gastrointestinal_questions.json",
        "Mental Health": "mental_health_questions.json",
        "Respiratory: Pediatrics": "pediatrics_respiratory_questions.json",
        "Adult Respiratory": "adult_respiratory_questions.json",
        "Neurology: Pediatrics": "pediatrics_neurology_questions.json",
        "Adult Neurology": "adult_neurology_questions.json",
        "Endocrine": "endocrine_questions.json",
        "Maternity": "maternity_questions.json"
    }
